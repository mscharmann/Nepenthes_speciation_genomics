...
# the pipeline itself
python $toolbase/draw_ms_priors.Nepenthes.2pop.2018-06-23.py -bpfile $bpfile -argfile $argfile | $toolbase/msnsam/msnsam tbs $msnsam_arg2 $msnsam_model_cmd | python $toolbase/ms2stats.arbitrary_npop.counter.py | python $toolbase/ms2stats.arbitrary_npop.stats.py
